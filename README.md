...
| `DELETE /api/monitoramento/mensagens/:id` | Apaga uma mensagem individual |
...
Documentação detalhada: [`docs/configuracao-kilo-code.md`](docs/configuracao-kilo-code.md)
