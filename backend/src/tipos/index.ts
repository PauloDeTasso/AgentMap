...
export type TipoHistoricoCoordenacao =
  ...
  | 'DISPATCH_SUCESSO'
  | 'DISPATCH_ERRO'
  | 'CONFIG_DISPATCH_ATUALIZADA'
  | 'DISPATCH_FALHA_PERMANENTE'
  | 'TRANSIÇÃO_ATUALIZADA'
