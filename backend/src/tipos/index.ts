...
export const TRANSICOES_ESTADO_TAREFA: Record<EstadoTarefa, EstadoTarefa[]> = {
  ...
  EM_EXECUCAO: ['EM_TESTE', 'EM_REVISAO', 'BLOQUEADA', 'CANCELADA', 'ORFA'],
  ...
  ORFA: ['RECUPERANDO', 'EM_EXECUCAO', 'BLOQUEADA', 'CANCELADA'],
  RECUPERANDO: ['PRONTA', 'CONCLUIDA', 'EM_EXECUCAO', 'BLOQUEADA', 'CANCELADA']
};
